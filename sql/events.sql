...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 28 avr. 2024 à 17:58
...
--
CREATE DATABASE IF NOT EXISTS `5ademni` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `5ademni`;
...
(11022063, 1111, 'Congrès', 'innovation technologique', '2024-04-26', 'Tunis', 80.00, 197, '../../upload/pexels-carlos-oliva-3586966.jpg', '09:00:00', 2),
...
--
ALTER TABLE `inscriptionevenement`
  MODIFY `id_inscription` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
-- Base de données : `mmh_atelier`
--
CREATE DATABASE IF NOT EXISTS `mmh_atelier` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mmh_atelier`;
...
INSERT INTO `employe` (`id`, `lastName`, `firstName`, `email`, `DoB`) VALUES
(19701, 'hammami', 'mmh', 'hammami.mohamedmalek@esprit.tn', '2024-03-04'),
(19702, 'hammami', 'mmh22', 'hammami.mohamedmalek@esprit.tn', '2003-08-14');
...
--
ALTER TABLE `employe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19703;
--
...
('root', '[{\"db\":\"5ademni\",\"table\":\"inscriptionevenement\"},{\"db\":\"5ademni\",\"table\":\"categorie_evenement\"},{\"db\":\"5ademni\",\"table\":\"evenement\"},{\"db\":\"5ademni\",\"table\":\"auteur\"}]');
...
('root', '2024-04-26 19:07:43', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
