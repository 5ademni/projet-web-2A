        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <h1 class="green-text">Bienvenue</h1>
                </div>
            </div>
            <section class="hero-section d-flex justify-content-center align-items-center">
                ...
                <div class="container">
                    <div class="row">
                        <!-- Column for the image and title -->
                        <div class="col-lg-6">
                            ...
                            if (isset($_GET['image'])) {
                                ...
                                $newWidth = 500; // Desired width
                                $newHeight = 300; // Desired height
                                // Display the image with the new dimensions
                                echo '<img src="' . $imagePath . '" alt="Image du projet" width="' . $newWidth . '" height="' . $newHeight . '">';
                            } else {
                                echo 'Image not found';
                            }
                            ?>
                            <a href="chat/index.php" class="chat-button" style="color: white;">
            ...
            <style>
                /* Classe personnalisée pour une marge supplémentaire vers le haut */
                .my-custom-margin {
                    margin-top: 250px;
...
<script>
    ...
    function validateForm() {
        ...
        // Contrôle de saisie pour 'participer'
        if (participer !== "oui" && participer !== "non") {
            appendErrorMessage("participer", "Le champ 'participer' doit être 'oui' ou 'non'.");
            return false;
        }

        // Contrôle de saisie pour 'disponibilite_horaire'
        if (disponibilite_horaire !== "matin" && disponibilite_horaire !== "soir") {
            appendErrorMessage("disponibilite_horaire", "Le champ 'disponibilite horaire' doit être 'matin' ou 'soir'.");
            return false;
        }

        // Assurez-vous de retourner 'true' à la fin si toutes les validations passent
        return true;
    }

    function appendErrorMessage(inputId, message) {
        var inputElement = document.getElementById(inputId);
        var errorDiv = document.createElement('div');
        errorDiv.className = 'error-message'; // Ajoutez un style pour cette classe dans votre CSS
