...
if (
    ...
    if (
        ...
        if (isset($_GET['ids']) && !empty($_GET['ids'])) {
            $specialiteC->updatespecialite($Specialite, $_GET['ids']);
    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php
            if (isset($_GET['ids'])) {
                $id = $_GET['ids'];
                $Specialite = $specialiteC->getSpecialite($id);
                ?>
        ...
        <form method="POST" id="insertForm" action="" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="noms" placeholder="Titre"
                                    value="<?php echo $Specialite['noms']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="descrips"
                                    rows="3"><?php echo $Specialite['descrips']; ?></textarea>
                            </div>
                        </div>
