...
$specialitess = new SpecialiteC();
$specialites = $specialitess->listspecialites();



foreach ($list as &$formation) {
  // Generate table string in text format for the current formation
  $formationAsString = "ID: " . $formation['id_formation'] . "\n" .
    "Titre: " . $formation['titre_formation'] . "\n" .
    "Durée: " . $formation['duretotale_formation'] . "\n" .
    "Description: " . $formation['description_formation'] . "\n" .
    "Prix: " . $formation['prix_formation'] . "\n" .
    "Specialités: " . $formation['noms'];

  // Generate QR code URL for the formation using api.qrserver.com
  $formation['qrCodeUrl'] = 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=' . urlencode($formationAsString);
}
?>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h5 class="card-title">Liste des Formation</h5>
            <i class="bi bi-plus-lg"></i>
          </a>
        </div>
  
        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#addFormationModal">
                Add new formation
              </button>
                  ...
                  <tbody>
                    ...
                    foreach ($list as $formation) {
                      ...
                      <tr>
                        ...
                        <td><?= $formation['titre_formation']; ?></td>
                        <td><?= $formation['duretotale_formation']; ?></td>
                        <td><?= $formation['description_formation']; ?></td>
                        <td><?= $formation['prix_formation']; ?></td>
                        <td><?= $formation['noms']; ?></td>
                        <td>
                          <img src="<?= $formation['qrCodeUrl']; ?>" alt="QR Code" style="width: 50px;">
                        </td>
                        <td align="center">
                          <a href="Updateformation.php?id=<?= $formation['id_formation']; ?>" class="btn"><i
                              class="fa-solid fa-pen-to-square fa-xl"></i>Update</a>
                          <a href="Deleteformation.php?id=<?= $formation['id_formation']; ?>" class="btn"><i
                              class="fa-solid fa-trash fa-xl"></i>Delete</a>
              ...
              <form method="POST" id="insertForm" action="upload.php" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="titre" placeholder="Formation Titre">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="description" placeholder="Formation Description">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="duree" placeholder="Formation Durée">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="prix" placeholder="Formation Prix">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-2">
                    <img class="preview_img" style="width: 100px;" src="images/default_profile.jpg">
                  </div>
                  <div class="col-10">
                  ...
                  <div class="row mb-3">
                    <div class="col">
                      ...
                      <select class="form-select" name="ids">
                        <?php
                        foreach ($specialites as $specialitess) {
                          $selected = '';
                          if (isset($_POST['specialite']) && $_POST['specialite'] == $specialitess['ids']) {
                            $selected = 'selected';
                          }
                          echo '<option value="' . $specialitess['ids'] . '" ' . $selected . '>' . $specialitess['noms'] . '</option>';
                        }
                        ?>
                      </select>
