...
$error = "";
$list = $specialiteC->listspecialites();
        ...
        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#addFormationModal">
              ...
              <div class="table-responsive p-0">
                ...
                <table class="table align-items-center justify-content-center mb-0" id="myTable" style="width:100%;">
                  ...
                  <tbody>
                    <?php
                    foreach ($list as $specialite) {
                      ?>
                      <tr>
                        <td><?= $specialite['ids']; ?></td>
                        <td><?= $specialite['noms']; ?></td>
                        <td><?= $specialite['descrips']; ?></td>
                        <td align="center">

                          <a href="Updatespecialite.php?ids=<?= $specialite['ids']; ?>" class="btn"><i
                              class="fa-solid fa-pen-to-square fa-xl"></i>Update</a>
                          <a href="Deletespecialite.php?ids=<?= $specialite['ids']; ?>" class="btn"><i
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="addFormationModalLabel">Add New Specialite</h5>
            ...
            <div class="modal-body">
              ...
              <form method="POST" id="insertForm" action="uploads.php" enctype="multipart/form-data">

                <div class="row mb-3">
                  <div class="col">
                    <label class="form-label">Nom</label>
                    <input type="text" class="form-control" name="noms" placeholder="specialite Titre">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="descrips" placeholder="specialite Description">
                  </div>
                </div>

                <button type="submit" class="btn btn-outline-dark me-1" id="insertBtn">add</button>
