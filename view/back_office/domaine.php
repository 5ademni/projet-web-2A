...
<div class="pagetitle">
  <h1>Page des domaines</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="index.php">Home</a></li>
      <li class="breadcrumb-item active">Les domaines</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
...
<div class="card">
  <div class="card-body">
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <a href="ajouter-domaine.php" class="btn btn-primary">
...
?>
<tr>
  <th scope="row"><?php echo $domaine['id_domaine']; ?></th>
